  ...
  "group/button inline-flex shrink-0 cursor-pointer items-center justify-center rounded-none border border-transparent bg-clip-padding text-xs font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-1 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        ghostSecondary: "hover:bg-secondary/20 dark:hover:bg-secondary/30",
        ghostAccent: "hover:bg-accent/20 dark:hover:bg-accent/30",
        ghostInfo: "hover:bg-info/20 dark:hover:bg-info/30",
        ghostSuccess: "hover:bg-success/20 dark:hover:bg-success/30",
        ghostWarning: "hover:bg-warning/20 dark:hover:bg-warning/30",
        ghostLink: "hover:text-link/20 dark:hover:text-link/30",
