...
export function AlbumTimeDistribution({
  albumId,
  period,
}: {
  albumId: number;
  ...
  const { data: result, isLoading } =
    api.chart.getAlbumTimeDistribution.useQuery(
      {
  ...
  return (
    <SeriesChartCard
      title="This album by hour"
      description="When you played this album's tracks during the day"
      chartConfig={{
        albumHourPercent: {
          label: "Share by hour",
          color: "var(--chart-1)",
      ...
      <CategoryBarChart<HourDatum>
        ...
        formatTooltipValue={(value, payload) => (
          <div className="flex flex-col gap-1">
            ...
            <div>{formatPercent(value)} of this album in the period</div>
            <div>
