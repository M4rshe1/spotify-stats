...
export const periods = {
  ...
  last_7_days: {
    ...
    previous: () => startOfDay(subDays(periodAnchorDate(), 7)),
    grouping: "day",
  },
  last_30_days: {
    label: "Last 30 Days",
    ...
    previous: () => startOfDay(subDays(periodAnchorDate(), 30)),
    grouping: "day",
  },
  last_90_days: {
    label: "Last 90 Days",
    ...
    previous: () => startOfDay(subDays(periodAnchorDate(), 90)),
    grouping: "day",
  },
  this_week: {
    label: "This Week",
  ...
  last_365_days: {
    ...
    previous: () => startOfDay(subDays(periodAnchorDate(), 365)),
    grouping: "month",
  },
  all_time: {
    label: "All Time",
